...
class _ChacekOutScreenState extends State<ChacekOutScreen> {
  ...
  Widget build(BuildContext context) {
   ...
   Padding(
     ...
     child: Row(children: [
       Text("Your Order Will be ",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
  ...
  Padding(
    ...
    child: Text("Delivered To",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold)),
  ...
  Padding(
    ...
    child: Text("Pyment Method",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,fontFamily: AutofillHints.addressState),),
  ),
  Row(children: [
    ...
    Padding(
      ...
      child: Icon(Icons.circle_outlined,color: Color(0xffc9c9c9),),
    )
  ],),
  Row(children: [
  ...
  ,),
    ...
    SizedBox(height: 20,),
                      ...
                      InkWell(
                        ...
                        child: Container(width: 360,height: 55,decoration: BoxDecoration(borderRadius: BorderRadius.circular(26), color: Color(0xfffcc874)),child: Center(child: Text("Place Order",style: TextStyle(fontSize: 18),)),))
